...
- `skills/report-templates.md` — platform-specific report structure (H1/Bugcrowd/Intigriti/Immunefi).
- `skills/report-templates.md` — impact-first templates, downgrade counters, and pre-submit checklist.
- `agents/validator.md` + `rules/reporting.md` — 7-Question Gate and never-submit list.
